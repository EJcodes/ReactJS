...
function Fc(e, n, t, r, l, u, o, i, s) {
  (Et = !1), (Tr = null), Dc.apply(Ic, arguments);
}
function jc(e, n, t, r, l, u, o, i, s) {
  if ((Fc.apply(this, arguments), Et)) {
    if (Et) {
      var c = Tr;
      (Et = !1), (Tr = null);
...
function Ju(e, n, t, r) {
  if (Dr) {
    var l = au(e, n, t, r);
    if (l === null) Ml(e, n, r, Ir, t), Ko(e, r);
...
var Ir = null;
function au(e, n, t, r) {
  if (((Ir = null), (e = Yu(r)), (e = Sn(e)), e !== null))
...
var ut = {
  ...
  Go = ge(nl),
  tf = A({}, nl, { dataTransfer: 0 }),
  rf = ge(tf),
  lf = A({}, Gt, { relatedTarget: 0 }),
  Pl = ge(lf),
  uf = A({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  of = ge(uf),
  sf = A({}, ut, {
...
var vf = A({}, Gt, {
  ...
  wf = ge(gf),
  Sf = A({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  kf = ge(Sf),
  Ef = A({}, nl, {
    deltaX: function (e) {
...
var xf = We && "TextEvent" in window && !Ct,
...
function Nf(e, n) {
  if (In)
    return e === "compositionend" || (!no && Fs(e, n))
      ? ((e = Ds()), (Sr = qu = en = null), (In = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function As(e) {
  if (e.propertyName === "value" && tl(Ft)) {
    var n = [];
    Us(n, Ft, e, Yu(e)), ws(Lf, n);
  }
}
function Rf(e, n, t) {
  e === "focusin"
    ? (ti(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", As))
    : e === "focusout" && ti();
}
function Of(e) {
...
var jf = We && "documentMode" in document && 11 >= document.documentMode,
  Fn = null,
  cu = null,
  xt = null,
  fu = !1;
  ...
  if (!e[ar]) {
    (e[ar] = !0),
      rs.forEach(function (t) {
        t !== "selectionchange" && (Af.has(t) || Ol(t, !1, e), Ol(t, !0, e));
      });
...
var ot = Math.random().toString(36).slice(2),
  ...
  hu = "__reactEvents$" + ot,
  Kf = "__reactListeners$" + ot,
  Yf = "__reactHandles$" + ot;
function Sn(e) {
  var n = e[Ie];
  if (n) return n;
...
function vn() {
  if (!Il && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Cs(Xu, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function ga(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), ol(4, 4, ya.bind(null, n, e), t)
  );
}
function wo() {}
function wa(e, n) {
...
function bf(e, n, t) {
  ...
  if (Ca(e)) _a(n, l);
    ...
    (t = la(e, n, l, r)),
      t !== null && ((l = ue()), Re(t, e, r, l), xa(t, n, r));
  }
}
function Ca(e) {
  var n = e.alternate;
...
var Yr = {
  ...
  ed = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        (l.queue = u),
        Si(fa.bind(null, r, u, e), [e]),
        (r.flags |= 2048),
        Qt(9, ca.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function zi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), Pa(n, t, r), Eu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[hu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Qo(t), n === 1))
      e.tag === 0 ? Xf(ji.bind(null, e)) : qs(ji.bind(null, e)),
        Wf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
  ...
  if (n !== 0) {
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = Co + 500 - W()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Gu(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ys = _o;
gs = Ln;
var Pd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, vs, hs, _o] },
  ht = {
  ...
  Nd = {
    ...
    findFiberByHostInstance: ht.findFiberByHostInstance || _d,
...
function Ld() {
  return Ae.jsxs("header", {
    children: [
      ...
      Ae.jsx("h1", { children: "React Essentials" }),
      Ae.jsx("p", {
        children:
...
function Td() {
  return Ae.jsxs("div", {
    children: [
      Ae.jsx(Ld, {}),
      Ae.jsx("main", {
        children: Ae.jsx("h2", { children: "Time to get started!" }),
      }),
    ],
  });
}
const Rd = document.getElementById("root");
Wl.createRoot(Rd).render(Ae.jsx(Td, {}));
